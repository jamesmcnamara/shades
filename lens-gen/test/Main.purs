...
import Lens (getbase, idx, modbase, path, setbase, traversal)
...
main = run [consoleReporter] do
  describe "tests" do
    ...
    describe "get tests" do
      ...
      describe "should stack with traversals" do
        ...
        pending' "should handle traversal on traversal actions" do
        ...
        pending' "should only apply constraints to last traversal" do
          (show $ (traversal >>> traversal >>> path) getbase) `shouldEqual` "declare function get<T1 extends Collection<T2>, T2 extends HasKey<K3>, K3 extends string>(t1: Traversal<T1>, t2: Traversal<T2>, k3: K3): <F1 extends Collection<T1>>(s: F1) => Functor<F1, T1, T2[K3]>"
      ...
      describe "spot check of complex combos" do
        ...
        pending' "TPT" do
          (show $ (traversal >>> path >>> path) getbase) `shouldEqual` "declare function get<T1 extends HasKey<K2, Collection<T3>>, K2 extends string>(t1: Traversal<T1>, k2: K2, t3: Traversal<T3>): <F1 extends Collection<T1>>(s: F1) => Functor<F1, T1, T2>"
        pending' "PTP" do 
        ...
        pending' "TTPPI" do
          (show $ (traversal >>> traversal >>> path >>> path >>> idx) getbase) `shouldEqual` "declare function get<T1 extends Collection<T2>, T2 extends HasKey<K3, HasKey<K4, Indexable>>, K3 extends string, K4 extends string>(t1: Traversal<T1>, t2: Traversal<T2>, k3: K3, k4: K4, i5: number): <F1 extends Collection<T1>>(s: F1) => Functor<F1, T1, Index<T2[K3][K4]>>"
        pending' "ITKK" do 
  ...
  describe "set tests" do
      ...
      describe "should stack with traversals" do
        ...
        pending' "should handle index" do
        ...
        pending' "should handle traversal on traversal actions" do
          (show $ (traversal >>> traversal) setbase) `shouldEqual` "declare function set<T1 extends Collection<T2>, T2>(t1: Traversal<T1>, t2: Traversal<T2>): (v: T2) => <S extends Collection<Collection<T2>>>(s: S) => S"

        pending' "should only apply constraints to last traversal" do
          (show $ (traversal >>> traversal >>> path) setbase) `shouldEqual` "declare function set<T1 extends Collection<T2>, T2 extends HasKey<K3>, K3 extends string>(t1: Traversal<T1>, t2: Traversal<T2>, k3: K3): (v: T2[K3]) => <S extends Collection<Collection<T2>>>(s: S) => S"
      ...
      describe "spot check of complex combos" do
        ...
        pending' "TTPPI" do
          (show $ (traversal >>> traversal >>> path >>> path >>> idx) setbase) `shouldEqual` "declare function set<T1 extends Collection<T2>, T2 extends HasKey<K3, HasKey<K4, Indexable>>, K3 extends string, K4 extends string>(t1: Traversal<T1>, t2: Traversal<T2>, k3: K3, k4: K4, i5: number): (v: Index<T2[K3][K4]>) => <S extends Collection<Collection<T2>>>(s: S) => S"
        pending' "ITKK" do 
  ...
  describe "mod tests" do
      pending' "should ouput basic signatures" do 
      ...
      pending' "should stack signatures together (w/o traversals)" do
      ...
      describe "should stack with traversals" do
        pending' "should handle paths" do
        ...
        pending' "should handle traversal on traversal actions" do
          (show $ (traversal >>> traversal) modbase) `shouldEqual` "declare function mod<T1 extends Collection<T2>, T2>(t1: Traversal<T1>, t2: Traversal<T2>): (f: (v: T2) => T2) => <S extends Collection<Collection<T2>>>(s: S) => S"

        pending' "should only apply constraints to last traversal" do
          (show $ (traversal >>> traversal >>> path) modbase) `shouldEqual` "declare function mod<T1 extends Collection<T2>, T2 extends HasKey<K3>, K3 extends string>(t1: Traversal<T1>, t2: Traversal<T2>, k3: K3): (f: (v: T2[K3]) => T2[K3]) => <S extends Collection<Collection<T2>>>(s: S) => S"
