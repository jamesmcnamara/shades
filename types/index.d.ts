...
export function filter<K extends string>(
  k: K
): <F extends Collection<HasKey<K>>>(f: F) => F;
export function filter<A>(f: (a: A) => any): <F>(f: F) => F;
export function filter<Pattern>(
  p: Pattern
): <F extends Collection<HasPattern<Pattern>>>(f: F) => F;

export function map<K extends string>(
  k: K
): <F extends Container<HasKey<K>>>(
  f: F
) => Functor<F, Unpack<F>, KeyAt<Unpack<F>, K>>;
export function map(
  i: number
): <F extends Container<Indexable>>(
  f: F
) => Functor<F, Unpack<F>, Index<Unpack<F>>>;
export function map<A, B>(
  f: (a: A) => B
): <F extends Container<A>>(f: F) => Functor<F, A, B>;
...
export function get<K1 extends string>(
  k1: K1
): <S extends HasKey<K1>>(s: S) => KeyAt<S, K1>;
...
export function get<K1 extends string, K2 extends string>(
  k1: K1,
  k2: K2
): <S extends HasKey<K1, HasKey<K2>>>(s: S) => KeyAt<KeyAt<S, K1>, K2>;

export function get<K1 extends string>(
  k1: K1,
  i2: number
): <S extends HasKey<K1, Indexable>>(s: S) => Index<KeyAt<S, K1>>;

export function get<K1 extends string, T2>(
  k1: K1,
  t2: Traversal<T2>
): <S extends HasKey<K1, Collection<T2>>>(s: S) => KeyAt<S, K1>;
...
export function get<K2 extends string>(
  i1: number,
  k2: K2
): <S extends Indexable<HasKey<K2>>>(s: S) => KeyAt<Index<S>, K2>;
...
export function get<T1, K2 extends string>(
  ...
  s: S
) => Functor<S, Unpack<S>, KeyAt<Unpack<S>, K2>>;
...
export function get<K1 extends string, K2 extends string, K3 extends string>(
  ...
  k2: K2,
  k3: K3
): <S extends HasKey<K1, HasKey<K2, HasKey<K3>>>>(
  s: S
) => KeyAt<KeyAt<KeyAt<S, K1>, K2>, K3>;

export function get<K1 extends string, K2 extends string>(
  k1: K1,
  k2: K2,
  i3: number
): <S extends HasKey<K1, HasKey<K2, Indexable>>>(
  s: S
) => Index<KeyAt<KeyAt<S, K1>, K2>>;

export function get<K1 extends string, K2 extends string, T3>(
  k1: K1,
  k2: K2,
  t3: Traversal<T3>
): <S extends HasKey<K1, HasKey<K2, Collection<T3>>>>(
  s: S
) => KeyAt<KeyAt<S, K1>, K2>;
...
export function get<K1 extends string, K3 extends string>(
  ...
  i2: number,
  k3: K3
): <S extends HasKey<K1, Indexable<HasKey<K3>>>>(
  s: S
) => KeyAt<Index<KeyAt<S, K1>>, K3>;

export function get<K1 extends string>(
  k1: K1,
  i2: number,
  i3: number
): <S extends HasKey<K1, Indexable<Indexable>>>(
  s: S
) => Index<Index<KeyAt<S, K1>>>;

export function get<K1 extends string, T3>(
  k1: K1,
  i2: number,
  t3: Traversal<T3>
): <S extends HasKey<K1, Indexable<Collection<T3>>>>(
  s: S
) => Index<KeyAt<S, K1>>;
...
export function get<K1 extends string, T2>(
  ...
  s: S
) => Functor<KeyAt<S, K1>, Unpack<KeyAt<S, K1>>, Index<Unpack<KeyAt<S, K1>>>>;

export function get<K1 extends string, T2, T3>(
  k1: K1,
  t2: Traversal<T2>,
  t3: Traversal<T3>
): <S extends HasKey<K1, Collection<T2 & Collection<T3>>>>(
  s: S
) => KeyAt<S, K1>;
...
export function get<K1 extends string, T2, S3, A3>(
  ...
  s: S
) => Functor<KeyAt<S, K1>, Unpack<KeyAt<S, K1>>, A3>;
...
export function get<
  ...
  K3 extends string
>(k1: K1, l2: Lens<S2, A2>, k3: K3): (s: HasKey<K1, S2>) => KeyAt<A2, K3>;
...
export function get<K2 extends string, K3 extends string>(
  ...
  k2: K2,
  k3: K3
): <S extends Indexable<HasKey<K2, HasKey<K3>>>>(
  s: S
) => KeyAt<KeyAt<Index<S>, K2>, K3>;

export function get<K2 extends string>(
  i1: number,
  k2: K2,
  i3: number
): <S extends Indexable<HasKey<K2, Indexable>>>(
  s: S
) => Index<KeyAt<Index<S>, K2>>;

export function get<K2 extends string, T3>(
  i1: number,
  k2: K2,
  t3: Traversal<T3>
): <S extends Indexable<HasKey<K2, Collection<T3>>>>(
  s: S
) => KeyAt<Index<S>, K2>;
...
export function get<K3 extends string>(
  ...
  i2: number,
  k3: K3
): <S extends Indexable<Indexable<HasKey<K3>>>>(
  s: S
) => KeyAt<Index<Index<S>>, K3>;
...
export function get<T2, K3 extends string>(
  ...
  s: S
) => Functor<Index<S>, Unpack<Index<S>>, KeyAt<Unpack<Index<S>>, K3>>;
...
export function get<T1, K2 extends string, K3 extends string>(
  ...
  s: S
) => Functor<S, Unpack<S>, KeyAt<KeyAt<Unpack<S>, K2>, K3>>;
...
export function get<T1, K2 extends string>(
  ...
  s: S
) => Functor<S, Unpack<S>, Index<KeyAt<Unpack<S>, K2>>>;
...
export function get<T1, K3 extends string>(
  ...
  s: S
) => Functor<S, Unpack<S>, KeyAt<Index<Unpack<S>>, K3>>;
...
export function get<T1, T2, K3 extends string>(
  ...
  S,
  Unpack<S>,
  Functor<Unpack<S>, Unpack<Unpack<S>>, KeyAt<Unpack<Unpack<S>>, K3>>
>;
...
export function get<T1, S2, A2 extends HasKey<K3>, K3 extends string>(
  ...
  s: S
) => Functor<S, Unpack<S>, KeyAt<A2, K3>>;
...
export function get<
  ...
  K2 extends string,
  K3 extends string
>(l1: Lens<S1, A1>, k2: K2, k3: K3): (s: S1) => KeyAt<KeyAt<A1, K2>, K3>;

export function get<S1, A1 extends HasKey<K2, Indexable>, K2 extends string>(
  l1: Lens<S1, A1>,
  k2: K2,
  i3: number
): (s: S1) => Index<KeyAt<A1, K2>>;
...
export function get<
  ...
  K2 extends string,
  T3
>(l1: Lens<S1, A1>, k2: K2, t3: Traversal<T3>): (s: S1) => KeyAt<A1, K2>;

export function get<S1, A1 extends HasKey<K2>, K2 extends string, A3>(
  l1: Lens<S1, A1>,
  k2: K2,
  l3: Lens<KeyAt<A1, K2>, A3>
): (s: S1) => A3;
...
>(
  ...
  t2: Traversal<T2>,
  k3: K3
): (s: S1) => Functor<A1, T2, KeyAt<T2, K3>>;
...
>(
  ...
  s: S
) => KeyAt<KeyAt<KeyAt<KeyAt<S, K1>, K2>, K3>, K4>;
...
export function get<K1 extends string, K2 extends string, K3 extends string>(
  ...
  s: S
) => Index<KeyAt<KeyAt<KeyAt<S, K1>, K2>, K3>>;
...
export function get<K1 extends string, K2 extends string, K4 extends string>(
  ...
  s: S
) => KeyAt<Index<KeyAt<KeyAt<S, K1>, K2>>, K4>;
...
export function get<K1 extends string, K2 extends string>(
  ...
  s: S
) => Index<Index<KeyAt<KeyAt<S, K1>, K2>>>;
...
export function get<K1 extends string, K2 extends string, T3, S4, A4>(
  ...
  s: S
) => Functor<KeyAt<KeyAt<S, K1>, K2>, Unpack<KeyAt<KeyAt<S, K1>, K2>>, A4>;
...
>(
  ...
  l3: Lens<S3, A3>,
  k4: K4
): (s: HasKey<K1, HasKey<K2, S3>>) => KeyAt<A3, K4>;
...
export function get<K1 extends string, K3 extends string, K4 extends string>(
  ...
  s: S
) => KeyAt<KeyAt<Index<KeyAt<S, K1>>, K3>, K4>;
...
export function get<K1 extends string, K3 extends string>(
  ...
  s: S
) => Index<KeyAt<Index<KeyAt<S, K1>>, K3>>;
...
export function get<K1 extends string, K4 extends string>(
  ...
  s: S
) => KeyAt<Index<Index<KeyAt<S, K1>>>, K4>;
...
export function get<K1 extends string, T3, K4 extends string>(
  ...
  Index<KeyAt<S, K1>>,
  Unpack<Index<KeyAt<S, K1>>>,
  KeyAt<Unpack<Index<KeyAt<S, K1>>>, K4>
>;
...
export function get<K1 extends string, T3, S4, A4>(
  ...
  s: S
) => Functor<Index<KeyAt<S, K1>>, Unpack<Index<KeyAt<S, K1>>>, A4>;
...
>(
  ...
  l3: Lens<S3, A3>,
  k4: K4
): (s: HasKey<K1, Indexable<S3>>) => KeyAt<A3, K4>;
...
>(
  ...
  KeyAt<S, K1>,
  Unpack<KeyAt<S, K1>>,
  KeyAt<KeyAt<Unpack<KeyAt<S, K1>>, K3>, K4>
>;
...
export function get<K1 extends string, T2, K3 extends string>(
  ...
  KeyAt<S, K1>,
  Unpack<KeyAt<S, K1>>,
  Index<KeyAt<Unpack<KeyAt<S, K1>>, K3>>
>;
...
export function get<K1 extends string, T2, K3 extends string, S4, A4>(
  ...
  s: S
) => Functor<KeyAt<S, K1>, Unpack<KeyAt<S, K1>>, A4>;
...
export function get<K1 extends string, T2, K4 extends string>(
  ...
  KeyAt<S, K1>,
  Unpack<KeyAt<S, K1>>,
  KeyAt<Index<Unpack<KeyAt<S, K1>>>, K4>
>;
...
export function get<K1 extends string, T2, T3, K4 extends string>(
  ...
  Functor<
    Unpack<KeyAt<S, K1>>,
    Unpack<Unpack<KeyAt<S, K1>>>,
    KeyAt<Unpack<Unpack<KeyAt<S, K1>>>, K4>
  >
>;
...
export function get<K1 extends string, T2, T3>(
  ...
  Functor<
    Unpack<KeyAt<S, K1>>,
    Unpack<Unpack<KeyAt<S, K1>>>,
    Index<Unpack<Unpack<KeyAt<S, K1>>>>
  >
>;
...
export function get<K1 extends string, T2, T3, S4, A4>(
  ...
  KeyAt<S, K1>,
  Unpack<KeyAt<S, K1>>,
  Functor<Unpack<KeyAt<S, K1>>, Unpack<Unpack<KeyAt<S, K1>>>, A4>
>;
...
>(
  ...
  s: S
) => Functor<KeyAt<S, K1>, Unpack<KeyAt<S, K1>>, KeyAt<A3, K4>>;
...
export function get<K1 extends string, T2, S3, A3 extends Indexable>(
  ...
  s: S
) => Functor<KeyAt<S, K1>, Unpack<KeyAt<S, K1>>, Index<A3>>;
...
>(
  ...
  k3: K3,
  k4: K4
): (s: HasKey<K1, S2>) => KeyAt<KeyAt<A2, K3>, K4>;
...
>(
  ...
  k3: K3,
  i4: number
): (s: HasKey<K1, S2>) => Index<KeyAt<A2, K3>>;
...
>(
  ...
  i3: number,
  k4: K4
): (s: HasKey<K1, S2>) => KeyAt<Index<A2>, K4>;
...
>(
  ...
  t3: Traversal<T3>,
  k4: K4
): (s: HasKey<K1, S2>) => Functor<A2, T3, KeyAt<T3, K4>>;
...
export function get<K2 extends string, K3 extends string, K4 extends string>(
  ...
  s: S
) => KeyAt<KeyAt<KeyAt<Index<S>, K2>, K3>, K4>;
...
export function get<K2 extends string, K3 extends string>(
  ...
  s: S
) => Index<KeyAt<KeyAt<Index<S>, K2>, K3>>;
...
export function get<K2 extends string, K4 extends string>(
  ...
  s: S
) => KeyAt<Index<KeyAt<Index<S>, K2>>, K4>;
...
export function get<K2 extends string, T3, K4 extends string>(
  ...
  KeyAt<Index<S>, K2>,
  Unpack<KeyAt<Index<S>, K2>>,
  KeyAt<Unpack<KeyAt<Index<S>, K2>>, K4>
>;
...
export function get<K2 extends string, T3, S4, A4>(
  ...
  s: S
) => Functor<KeyAt<Index<S>, K2>, Unpack<KeyAt<Index<S>, K2>>, A4>;
...
>(
  ...
  l3: Lens<S3, A3>,
  k4: K4
): (s: Indexable<HasKey<K2, S3>>) => KeyAt<A3, K4>;
...
export function get<K3 extends string, K4 extends string>(
  ...
  s: S
) => KeyAt<KeyAt<Index<Index<S>>, K3>, K4>;
...
export function get<S3, A3 extends HasKey<K4>, K4 extends string>(
  ...
  l3: Lens<S3, A3>,
  k4: K4
): (s: Indexable<Indexable<S3>>) => KeyAt<A3, K4>;
...
export function get<T2, K3 extends string, K4 extends string>(
  ...
  Index<S>,
  Unpack<Index<S>>,
  KeyAt<KeyAt<Unpack<Index<S>>, K3>, K4>
>;
...
export function get<T2, K3 extends string>(
  ...
  s: S
) => Functor<Index<S>, Unpack<Index<S>>, Index<KeyAt<Unpack<Index<S>>, K3>>>;
...
export function get<T2, K4 extends string>(
  ...
  s: S
) => Functor<Index<S>, Unpack<Index<S>>, KeyAt<Index<Unpack<Index<S>>>, K4>>;
...
export function get<T2, T3, K4 extends string>(
  ...
  Functor<
    ...
    KeyAt<Unpack<Unpack<Index<S>>>, K4>
  >
>;
...
export function get<T2, S3, A3 extends HasKey<K4>, K4 extends string>(
  ...
  s: S
) => Functor<Index<S>, Unpack<Index<S>>, KeyAt<A3, K4>>;
...
>(
  ...
  k3: K3,
  k4: K4
): (s: Indexable<S2>) => KeyAt<KeyAt<A2, K3>, K4>;
...
export function get<S2, A2 extends HasKey<K3, Indexable>, K3 extends string>(
  ...
  k3: K3,
  i4: number
): (s: Indexable<S2>) => Index<KeyAt<A2, K3>>;
...
export function get<S2, A2 extends Indexable<HasKey<K4>>, K4 extends string>(
  ...
  i3: number,
  k4: K4
): (s: Indexable<S2>) => KeyAt<Index<A2>, K4>;
...
>(
  ...
  t3: Traversal<T3>,
  k4: K4
): (s: Indexable<S2>) => Functor<A2, T3, KeyAt<T3, K4>>;
...
>(
  ...
  s: S
) => Functor<S, Unpack<S>, KeyAt<KeyAt<KeyAt<Unpack<S>, K2>, K3>, K4>>;
...
export function get<T1, K2 extends string, K3 extends string>(
  ...
  s: S
) => Functor<S, Unpack<S>, Index<KeyAt<KeyAt<Unpack<S>, K2>, K3>>>;
...
export function get<T1, K2 extends string, K4 extends string>(
  ...
  s: S
) => Functor<S, Unpack<S>, KeyAt<Index<KeyAt<Unpack<S>, K2>>, K4>>;
...
export function get<T1, K2 extends string>(
  ...
  s: S
) => Functor<S, Unpack<S>, Index<Index<KeyAt<Unpack<S>, K2>>>>;
...
export function get<T1, K2 extends string, T3, S4, A4>(
  ...
  S,
  Unpack<S>,
  Functor<KeyAt<Unpack<S>, K2>, Unpack<KeyAt<Unpack<S>, K2>>, A4>
>;
...
>(
  ...
  s: S
) => Functor<S, Unpack<S>, KeyAt<A3, K4>>;
...
export function get<T1, K3 extends string, K4 extends string>(
  ...
  s: S
) => Functor<S, Unpack<S>, KeyAt<KeyAt<Index<Unpack<S>>, K3>, K4>>;
...
export function get<T1, K3 extends string>(
  ...
  s: S
) => Functor<S, Unpack<S>, Index<KeyAt<Index<Unpack<S>>, K3>>>;
...
export function get<T1, K4 extends string>(
  ...
  s: S
) => Functor<S, Unpack<S>, KeyAt<Index<Index<Unpack<S>>>, K4>>;
...
export function get<T1, T3, K4 extends string>(
  ...
  Functor<
    ...
    KeyAt<Unpack<Index<Unpack<S>>>, K4>
  >
>;
...
export function get<T1, T2, K3 extends string, K4 extends string>(
  ...
  S,
  Unpack<S>,
  Functor<Unpack<S>, Unpack<Unpack<S>>, KeyAt<KeyAt<Unpack<Unpack<S>>, K3>, K4>>
>;
...
export function get<T1, T2, K3 extends string>(
  ...
  S,
  Unpack<S>,
  Functor<Unpack<S>, Unpack<Unpack<S>>, Index<KeyAt<Unpack<Unpack<S>>, K3>>>
>;
...
export function get<T1, T2, K4 extends string>(
  ...
  S,
  Unpack<S>,
  Functor<Unpack<S>, Unpack<Unpack<S>>, KeyAt<Index<Unpack<Unpack<S>>>, K4>>
>;
...
export function get<T1, T2, T3, K4 extends string>(
  ...
  Functor<
    ...
    Functor<
      ...
      KeyAt<Unpack<Unpack<Unpack<S>>>, K4>
    >
  >
>;
...
export function get<T1, T2, S3, A3 extends HasKey<K4>, K4 extends string>(
  ...
  S,
  Unpack<S>,
  Functor<Unpack<S>, Unpack<Unpack<S>>, KeyAt<A3, K4>>
>;
...
>(
  ...
  s: S
) => Functor<S, Unpack<S>, KeyAt<KeyAt<A2, K3>, K4>>;
...
>(
  ...
  s: S
) => Functor<S, Unpack<S>, Index<KeyAt<A2, K3>>>;
...
>(
  ...
  s: S
) => Functor<S, Unpack<S>, KeyAt<Index<A2>, K4>>;
...
>(
  ...
  s: S
) => Functor<S, Unpack<S>, Functor<A2, T3, KeyAt<T3, K4>>>;
...
>(
  ...
  k3: K3,
  k4: K4
): (s: S1) => KeyAt<KeyAt<KeyAt<A1, K2>, K3>, K4>;
...
>(
  ...
  k3: K3,
  i4: number
): (s: S1) => Index<KeyAt<KeyAt<A1, K2>, K3>>;
...
>(
  ...
  k2: K2,
  k3: K3,
  l4: Lens<KeyAt<KeyAt<A1, K2>, K3>, A4>
): (s: S1) => A4;
...
>(
  ...
  i3: number,
  k4: K4
): (s: S1) => KeyAt<Index<KeyAt<A1, K2>>, K4>;
...
>(
  ...
  t3: Traversal<T3>,
  k4: K4
): (s: S1) => Functor<KeyAt<A1, K2>, T3, KeyAt<T3, K4>>;
...
>(
  ...
  t3: Traversal<T3>,
  i4: number
): (s: S1) => Functor<KeyAt<A1, K2>, T3, Index<T3>>;
...
>(
  ...
  t3: Traversal<T3>,
  l4: Lens<T3, A4>
): (s: S1) => Functor<KeyAt<A1, K2>, T3, A4>;
...
>(
  ...
  k3: K3,
  k4: K4
): (s: S1) => KeyAt<KeyAt<Index<A1>, K3>, K4>;
...
>(
  ...
  t3: Traversal<T3>,
  k4: K4
): (s: S1) => Functor<Index<A1>, T3, KeyAt<T3, K4>>;
...
>(
  ...
  k3: K3,
  k4: K4
): (s: S1) => Functor<A1, T2, KeyAt<KeyAt<T2, K3>, K4>>;
...
>(
  ...
  k3: K3,
  i4: number
): (s: S1) => Functor<A1, T2, Index<KeyAt<T2, K3>>>;
...
>(
  ...
  i3: number,
  k4: K4
): (s: S1) => Functor<A1, T2, KeyAt<Index<T2>, K4>>;
...
>(
  ...
  t3: Traversal<T3>,
  k4: K4
): (s: S1) => Functor<A1, T2, Functor<T2, T3, KeyAt<T3, K4>>>;
...
>(
  ...
  l3: Lens<T2, A3>,
  k4: K4
): (s: S1) => Functor<A1, T2, KeyAt<A3, K4>>;
...
>(
  ...
  t3: Traversal<T3>,
  k4: K4
): (s: S1) => Functor<A2, T3, KeyAt<T3, K4>>;
...
>(
  ...
  l2: Lens<S2, A2>,
  k3: K3
): (v: KeyAt<A2, K3>) => <S extends HasKey<K1, S2>>(s: S) => S;
...
export function set<S2, A2 extends HasKey<K3>, K3 extends string>(
  ...
  l2: Lens<S2, A2>,
  k3: K3
): (v: KeyAt<A2, K3>) => <S extends Indexable<S2>>(s: S) => S;
...
export function set<T1, S2, A2 extends HasKey<K3>, K3 extends string>(
  ...
  l2: Lens<S2, A2>,
  k3: K3
): (v: KeyAt<A2, K3>) => <S extends Collection<T1 & S2>>(s: S) => S;
...
>(
  ...
  l3: Lens<S3, A3>,
  k4: K4
): (v: KeyAt<A3, K4>) => <S extends HasKey<K1, HasKey<K2, S3>>>(s: S) => S;
...
>(
  ...
  l3: Lens<S3, A3>,
  k4: K4
): (v: KeyAt<A3, K4>) => <S extends HasKey<K1, Indexable<S3>>>(s: S) => S;
...
>(
  ...
  l3: Lens<S3, A3>,
  k4: K4
): (v: KeyAt<A3, K4>) => <S extends HasKey<K1, Collection<T2 & S3>>>(s: S) => S;
...
>(
  ...
  k3: K3,
  k4: K4
): (v: KeyAt<KeyAt<A2, K3>, K4>) => <S extends HasKey<K1, S2>>(s: S) => S;
...
>(
  ...
  k3: K3,
  i4: number
): (v: Index<KeyAt<A2, K3>>) => <S extends HasKey<K1, S2>>(s: S) => S;
...
>(
  ...
  k3: K3,
  t4: Traversal<T4>
): (v: Unpack<KeyAt<A2, K3>>) => <S extends HasKey<K1, S2>>(s: S) => S;
...
>(
  ...
  i3: number,
  k4: K4
): (v: KeyAt<Index<A2>, K4>) => <S extends HasKey<K1, S2>>(s: S) => S;
...
>(
  ...
  t3: Traversal<T3>,
  k4: K4
): (v: KeyAt<Unpack<A2>, K4>) => <S extends HasKey<K1, S2>>(s: S) => S;
...
>(
  ...
  l3: Lens<A2, A3>,
  k4: K4
): (v: KeyAt<A3, K4>) => <S extends HasKey<K1, S2>>(s: S) => S;
...
>(
  ...
  l3: Lens<S3, A3>,
  k4: K4
): (v: KeyAt<A3, K4>) => <S extends Indexable<HasKey<K2, S3>>>(s: S) => S;
...
export function set<S3, A3 extends HasKey<K4>, K4 extends string>(
  ...
  l3: Lens<S3, A3>,
  k4: K4
): (v: KeyAt<A3, K4>) => <S extends Indexable<Indexable<S3>>>(s: S) => S;
...
export function set<T2, S3, A3 extends HasKey<K4>, K4 extends string>(
  ...
  l3: Lens<S3, A3>,
  k4: K4
): (v: KeyAt<A3, K4>) => <S extends Indexable<Collection<T2 & S3>>>(s: S) => S;
...
>(
  ...
  k3: K3,
  k4: K4
): (v: KeyAt<KeyAt<A2, K3>, K4>) => <S extends Indexable<S2>>(s: S) => S;
...
export function set<S2, A2 extends HasKey<K3, Indexable>, K3 extends string>(
  ...
  k3: K3,
  i4: number
): (v: Index<KeyAt<A2, K3>>) => <S extends Indexable<S2>>(s: S) => S;
...
>(
  ...
  k3: K3,
  t4: Traversal<T4>
): (v: Unpack<KeyAt<A2, K3>>) => <S extends Indexable<S2>>(s: S) => S;
...
export function set<S2, A2 extends Indexable<HasKey<K4>>, K4 extends string>(
  ...
  i3: number,
  k4: K4
): (v: KeyAt<Index<A2>, K4>) => <S extends Indexable<S2>>(s: S) => S;
...
>(
  ...
  t3: Traversal<T3>,
  k4: K4
): (v: KeyAt<Unpack<A2>, K4>) => <S extends Indexable<S2>>(s: S) => S;
...
export function set<S2, A2, A3 extends HasKey<K4>, K4 extends string>(
  ...
  l3: Lens<A2, A3>,
  k4: K4
): (v: KeyAt<A3, K4>) => <S extends Indexable<S2>>(s: S) => S;
...
>(
  ...
  l3: Lens<S3, A3>,
  k4: K4
): (v: KeyAt<A3, K4>) => <S extends Collection<T1 & HasKey<K2, S3>>>(s: S) => S;
...
export function set<T1, S3, A3 extends HasKey<K4>, K4 extends string>(
  ...
  l3: Lens<S3, A3>,
  k4: K4
): (v: KeyAt<A3, K4>) => <S extends Collection<T1 & Indexable<S3>>>(s: S) => S;
...
>(
  ...
  k3: K3,
  k4: K4
): (v: KeyAt<KeyAt<A2, K3>, K4>) => <S extends Collection<T1 & S2>>(s: S) => S;
...
>(
  ...
  k3: K3,
  i4: number
): (v: Index<KeyAt<A2, K3>>) => <S extends Collection<T1 & S2>>(s: S) => S;
...
>(
  ...
  k3: K3,
  t4: Traversal<T4>
): (v: Unpack<KeyAt<A2, K3>>) => <S extends Collection<T1 & S2>>(s: S) => S;
...
>(
  ...
  i3: number,
  k4: K4
): (v: KeyAt<Index<A2>, K4>) => <S extends Collection<T1 & S2>>(s: S) => S;
...
>(
  ...
  t3: Traversal<T3>,
  k4: K4
): (v: KeyAt<Unpack<A2>, K4>) => <S extends Collection<T1 & S2>>(s: S) => S;
...
export function set<T1, S2, A2, A3 extends HasKey<K4>, K4 extends string>(
  ...
  l3: Lens<A2, A3>,
  k4: K4
): (v: KeyAt<A3, K4>) => <S extends Collection<T1 & S2>>(s: S) => S;
...
>(
  ...
  k3: K3,
  k4: K4
): (v: KeyAt<KeyAt<KeyAt<A1, K2>, K3>, K4>) => (s: S1) => S1;
...
>(
  ...
  k3: K3,
  i4: number
): (v: Index<KeyAt<KeyAt<A1, K2>, K3>>) => (s: S1) => S1;
...
>(
  ...
  k3: K3,
  t4: Traversal<T4>
): (v: Unpack<KeyAt<KeyAt<A1, K2>, K3>>) => (s: S1) => S1;
...
>(
  ...
  i3: number,
  k4: K4
): (v: KeyAt<Index<KeyAt<A1, K2>>, K4>) => (s: S1) => S1;
...
>(
  ...
  i3: number,
  i4: number
): (v: Index<Index<KeyAt<A1, K2>>>) => (s: S1) => S1;
...
>(
  ...
  i3: number,
  t4: Traversal<T4>
): (v: Unpack<Index<KeyAt<A1, K2>>>) => (s: S1) => S1;
...
>(
  ...
  t3: Traversal<T3>,
  k4: K4
): (v: KeyAt<Unpack<KeyAt<A1, K2>>, K4>) => (s: S1) => S1;
...
>(
  ...
  t3: Traversal<T3>,
  i4: number
): (v: Index<Unpack<KeyAt<A1, K2>>>) => (s: S1) => S1;
...
>(
  ...
  t3: Traversal<T3>,
  t4: Traversal<T4>
): (v: Unpack<Unpack<KeyAt<A1, K2>>>) => (s: S1) => S1;
...
>(
  ...
  k3: K3,
  k4: K4
): (v: KeyAt<KeyAt<Index<A1>, K3>, K4>) => (s: S1) => S1;
...
>(
  ...
  k3: K3,
  i4: number
): (v: Index<KeyAt<Index<A1>, K3>>) => (s: S1) => S1;
...
>(
  ...
  k3: K3,
  t4: Traversal<T4>
): (v: Unpack<KeyAt<Index<A1>, K3>>) => (s: S1) => S1;
...
>(
  ...
  i3: number,
  k4: K4
): (v: KeyAt<Index<Index<A1>>, K4>) => (s: S1) => S1;
...
>(
  ...
  t3: Traversal<T3>,
  k4: K4
): (v: KeyAt<Unpack<Index<A1>>, K4>) => (s: S1) => S1;
...
>(
  ...
  k3: K3,
  k4: K4
): (v: KeyAt<KeyAt<Unpack<A1>, K3>, K4>) => (s: S1) => S1;
...
>(
  ...
  k3: K3,
  i4: number
): (v: Index<KeyAt<Unpack<A1>, K3>>) => (s: S1) => S1;
...
>(
  ...
  k3: K3,
  t4: Traversal<T4>
): (v: Unpack<KeyAt<Unpack<A1>, K3>>) => (s: S1) => S1;
...
>(
  ...
  i3: number,
  k4: K4
): (v: KeyAt<Index<Unpack<A1>>, K4>) => (s: S1) => S1;
...
>(
  ...
  t3: Traversal<T3>,
  k4: K4
): (v: KeyAt<Unpack<Unpack<A1>>, K4>) => (s: S1) => S1;
...
>(
  ...
  k3: K3,
  k4: K4
): (v: KeyAt<KeyAt<A2, K3>, K4>) => (s: S1) => S1;
...
export function mod<S1, A1 extends HasKey<K2>, K2 extends string>(
  l1: Lens<S1, A1>,
  k2: K2
): (f: (v: KeyAt<A1, K2>) => KeyAt<A1, K2>) => (s: S1) => S1;
...
>(
  ...
  f: (v: KeyAt<KeyAt<A1, K2>, K3>) => KeyAt<KeyAt<A1, K2>, K3>
) => (s: S1) => S1;
...
export function mod<S1, A1 extends HasKey<K2, Indexable>, K2 extends string>(
  ...
  k2: K2,
  i3: number
): (f: (v: Index<KeyAt<A1, K2>>) => Index<KeyAt<A1, K2>>) => (s: S1) => S1;
...
>(
  ...
  k2: K2,
  t3: Traversal<T3>
): (f: (v: Unpack<KeyAt<A1, K2>>) => Unpack<KeyAt<A1, K2>>) => (s: S1) => S1;
...
export function mod<S1, A1 extends Indexable<HasKey<K3>>, K3 extends string>(
  ...
  i2: number,
  k3: K3
): (f: (v: KeyAt<Index<A1>, K3>) => KeyAt<Index<A1>, K3>) => (s: S1) => S1;
...
>(
  ...
  t2: Traversal<T2>,
  k3: K3
): (f: (v: KeyAt<Unpack<A1>, K3>) => KeyAt<Unpack<A1>, K3>) => (s: S1) => S1;
...
export function mod<S1, A1, A2 extends HasKey<K3>, K3 extends string>(
  ...
  l2: Lens<A1, A2>,
  k3: K3
): (f: (v: KeyAt<A2, K3>) => KeyAt<A2, K3>) => (s: S1) => S1;
...
>(
  ...
  f: (v: KeyAt<KeyAt<A2, K3>, K4>) => KeyAt<KeyAt<A2, K3>, K4>
) => <S extends HasKey<K1, S2>>(s: S) => S;
...
>(
  ...
  f: (v: Index<KeyAt<A2, K3>>) => Index<KeyAt<A2, K3>>
) => <S extends HasKey<K1, S2>>(s: S) => S;
...
>(
  ...
  f: (v: Unpack<KeyAt<A2, K3>>) => Unpack<KeyAt<A2, K3>>
) => <S extends HasKey<K1, S2>>(s: S) => S;
...
>(
  ...
  f: (v: KeyAt<Index<A2>, K4>) => KeyAt<Index<A2>, K4>
) => <S extends HasKey<K1, S2>>(s: S) => S;
...
>(
  ...
  f: (v: KeyAt<Unpack<A2>, K4>) => KeyAt<Unpack<A2>, K4>
) => <S extends HasKey<K1, S2>>(s: S) => S;
...
>(
  ...
  f: (
    v: KeyAt<KeyAt<KeyAt<A1, K2>, K3>, K4>
  ) => KeyAt<KeyAt<KeyAt<A1, K2>, K3>, K4>
) => (s: S1) => S1;
...
>(
  ...
  f: (v: Index<KeyAt<KeyAt<A1, K2>, K3>>) => Index<KeyAt<KeyAt<A1, K2>, K3>>
) => (s: S1) => S1;
...
>(
  ...
  f: (v: Unpack<KeyAt<KeyAt<A1, K2>, K3>>) => Unpack<KeyAt<KeyAt<A1, K2>, K3>>
) => (s: S1) => S1;
...
>(
  ...
  f: (v: KeyAt<Index<KeyAt<A1, K2>>, K4>) => KeyAt<Index<KeyAt<A1, K2>>, K4>
) => (s: S1) => S1;
...
>(
  ...
  f: (v: Index<Index<KeyAt<A1, K2>>>) => Index<Index<KeyAt<A1, K2>>>
) => (s: S1) => S1;
...
>(
  ...
  f: (v: Unpack<Index<KeyAt<A1, K2>>>) => Unpack<Index<KeyAt<A1, K2>>>
) => (s: S1) => S1;
...
>(
  ...
  f: (v: KeyAt<Unpack<KeyAt<A1, K2>>, K4>) => KeyAt<Unpack<KeyAt<A1, K2>>, K4>
) => (s: S1) => S1;
...
>(
  ...
  f: (v: Index<Unpack<KeyAt<A1, K2>>>) => Index<Unpack<KeyAt<A1, K2>>>
) => (s: S1) => S1;
...
>(
  ...
  f: (v: Unpack<Unpack<KeyAt<A1, K2>>>) => Unpack<Unpack<KeyAt<A1, K2>>>
) => (s: S1) => S1;
...
>(
  ...
  l3: Lens<KeyAt<A1, K2>, A3>,
  k4: K4
): (f: (v: KeyAt<A3, K4>) => KeyAt<A3, K4>) => (s: S1) => S1;
...
>(
  ...
  f: (v: KeyAt<KeyAt<Index<A1>, K3>, K4>) => KeyAt<KeyAt<Index<A1>, K3>, K4>
) => (s: S1) => S1;
...
>(
  ...
  f: (v: Index<KeyAt<Index<A1>, K3>>) => Index<KeyAt<Index<A1>, K3>>
) => (s: S1) => S1;
...
>(
  ...
  f: (v: Unpack<KeyAt<Index<A1>, K3>>) => Unpack<KeyAt<Index<A1>, K3>>
) => (s: S1) => S1;
...
>(
  ...
  f: (v: KeyAt<Index<Index<A1>>, K4>) => KeyAt<Index<Index<A1>>, K4>
) => (s: S1) => S1;
...
>(
  ...
  f: (v: KeyAt<Unpack<Index<A1>>, K4>) => KeyAt<Unpack<Index<A1>>, K4>
) => (s: S1) => S1;
...
>(
  ...
  f: (v: KeyAt<KeyAt<Unpack<A1>, K3>, K4>) => KeyAt<KeyAt<Unpack<A1>, K3>, K4>
) => (s: S1) => S1;
...
>(
  ...
  f: (v: Index<KeyAt<Unpack<A1>, K3>>) => Index<KeyAt<Unpack<A1>, K3>>
) => (s: S1) => S1;
...
>(
  ...
  f: (v: Unpack<KeyAt<Unpack<A1>, K3>>) => Unpack<KeyAt<Unpack<A1>, K3>>
) => (s: S1) => S1;
...
>(
  ...
  f: (v: KeyAt<Index<Unpack<A1>>, K4>) => KeyAt<Index<Unpack<A1>>, K4>
) => (s: S1) => S1;
...
>(
  ...
  f: (v: KeyAt<Unpack<Unpack<A1>>, K4>) => KeyAt<Unpack<Unpack<A1>>, K4>
) => (s: S1) => S1;
...
>(
  ...
  k3: K3,
  i4: number
): (f: (v: Index<KeyAt<A2, K3>>) => Index<KeyAt<A2, K3>>) => (s: S1) => S1;
...
>(
  ...
  k3: K3,
  t4: Traversal<T4>
): (f: (v: Unpack<KeyAt<A2, K3>>) => Unpack<KeyAt<A2, K3>>) => (s: S1) => S1;
...
>(
  ...
  i3: number,
  k4: K4
): (f: (v: KeyAt<Index<A2>, K4>) => KeyAt<Index<A2>, K4>) => (s: S1) => S1;
...
>(
  ...
  t3: Traversal<T3>,
  k4: K4
): (f: (v: KeyAt<Unpack<A2>, K4>) => KeyAt<Unpack<A2>, K4>) => (s: S1) => S1;
